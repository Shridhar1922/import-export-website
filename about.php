...
<section class="info-section section-gap ">
    <div class="container">
        ...
        <div class="row no-margin-l-r">
            <div class="col-lg-6 col-md-12 col-sm-12 team-box">
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-12 ">
                        <div class="management-item">
                            <div class="mngmt-id">
                                <img src="./assets/img/team/SHASHIKANT_UNAVANE.jpg" alt="md">
                            </div>
                            <h3>SHASHIKANT K. UNAVANE </h3>
                            <p>FOUNDER & M.D.</p>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="management-item">
                            <div class="mngmt-id">
                                <img src="./assets/img/team/RAVIKANT_UNAVANE.jpg" alt="md">
                            </div>
                            <h3>RAVIKANT K.UNAVANE </h3>
                            <p>MARKETING HEAD</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-6 col-sm-12" data-aos="zoom-out-up">
                <div class="vision-mission-box">
                    <h1>Our Vision</h1>
                    <p>Our vision is to see global economical growth and elevated quality of living through
                        international business and commerce.</p>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12" data-aos="zoom-out-up">
                <div class="vision-mission-box">
                    <h1>Our Mission</h1>
                    <p>The mission of “Shramuk Overseas” is connect the world with contributing culture & taste ,&
                        enhance trust with regards to INDIA in International Trade.</p>
                </div>
            </div>
        </div>
    </div>
